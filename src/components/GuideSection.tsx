      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <Step
            ...
            tips={[
              "Отзывы обновляются автоматически каждые 10 минут",
      ...
      <div className="space-y-4">
        ...
        <Card className="p-5 space-y-4">
          ...
          <FaqItem
            ...
            answer="Автоматически каждые 10 минут. Также вы можете нажать кнопку «Синхронизировать» для мгновенного обновления."
          />
          <FaqItem
